  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-content flex-col px-m py-xl">
      <header className="mb-xxl text-center">
        <AppLogo />
        <p className="mt-m text-lg text-text-secondary">{HOME_TAGLINE}</p>
      </header>

      <section className="mb-xxl">
        <h1 className="mb-s text-2xl font-semibold text-text-primary">{HOME_MISSION_TITLE}</h1>
        <p className="text-base leading-relaxed text-text-secondary">{HOME_MISSION}</p>
      </section>
